...
const Home = () => {
  ...
  return (
    <div className='relative' ref={comp}>
      ...
      <Particles />
      <div className='h-screen flex flex-col gap-10 bg-gray-950 justify-center place-items-center'>
          <h1 id="welcome-1" className='text-gray-100 text-9xl font-bold font-spaceGrotesk'>Welcome to Quiz </h1>
          <h1 id="welcome-2" className='text-gray-100 text-9xl font-bold font-spaceGrotesk'>Generator.</h1>
          <p id="welcome-3" className='text-gray-100 text-2xl font-semibold font-spaceGrotesk'>Transform Learning with Our Quiz Generator</p>
          <button id="welcome-4" onClick={() => navigate('/login')} className='bg-gray-100 text-black px-8 py-3 rounded-sm text-lg font-semibold hover:bg-gray-500 hover:text-gray-900 transition-colors'>Get Started</button>
          <p id="welcome-5" className='relative text-gray-100 text-xs font-semibold font-spaceGrotesk top-30'>Our AI can make mistakes. Check important info.</p>
      </div>
